...
| Kostenlose Website für Moscheen | `website-fuer-moscheen.html` | Privates Angebot des Erstellers: kostenlose Website für andere Moscheen. Verlinkt aus der Fußzeile; Texte in `content/service.json`, Kontaktwege in `content/settings.json` unter `service` |
